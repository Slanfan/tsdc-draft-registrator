...
function selectCard(id) {
    ...
    if ($("#card-" + id).hasClass("selected")) {
        ...
        $(".card").each(function () {
            ...
            $("#card-" + id).find( ".pick-button" ).animate({ "bottom": "8vh" }, 300 );
